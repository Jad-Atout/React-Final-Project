...
export function Login() {
    ...
    const {setLogin,login,set_user_data} = useContext(Context)
        ...
        onSubmit:async (values)=>{
            ...
            try {
                ...
                if (data.data.message === 'success') {
                    ...
                    setLogin(true)
                    set_user_data(jwtDecode(data.data.token))
                    navigate('/')
                }
            }catch(error){
            ...
            <div className={`${style.login}`}>
                ...
                <div className={style.form}>
                    <form onSubmit={formik.handleSubmit}>
                        <div className={`mb-3 d-flex  ${style.form_section}`}>

                            <input type={'email'}
                                   placeholder={'Email'}
                                   className={` w-auto ${style.custom_form_control}`}
                                   id={'email'} value={formik.values.email}
                                   onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                            {(formik.touched.email && formik.errors.email) ?
                                <div className={style.form_errors}>{formik.errors.email}</div> : null}
                        </div>
                        <div className={`mb-3 d-flex  ${style.form_section} `}>
                            ...
                            {(formik.touched.password && formik.errors.password) ?
                                <div className={style.form_errors}>{formik.errors.password}</div> : null}
                        </div>
                        {(loginError)? <div className={style.form_errors}>{loginError}</div> : null}
